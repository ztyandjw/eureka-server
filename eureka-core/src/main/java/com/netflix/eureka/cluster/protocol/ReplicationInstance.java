...
public class ReplicationInstance {
    ...
    public static ReplicationInstanceBuilder replicationInstance() {
        return ReplicationInstanceBuilder.replicationInstanceBuilder;
    }
    ...
    public static class ReplicationInstanceBuilder {
        ...
        private InstanceInfo instanceInfo;
        private Action action;
        public static ReplicationInstanceBuilder replicationInstanceBuilder =  new ReplicationInstanceBuilder();
...
//        }
        ...
        public ReplicationInstanceBuilder but() {
            return replicationInstanceBuilder.withAppName(appName).withId(id).withLastDirtyTimestamp(lastDirtyTimestamp).withOverriddenStatus(overriddenStatus).withStatus(status).withInstanceInfo(instanceInfo).withAction(action);
        }
